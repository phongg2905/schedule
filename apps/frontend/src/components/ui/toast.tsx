...
const variantStyles: Record<ToastVariant, string> = {
  ...
  warning: "bg-[#FFF8F0] border-[#FFF0DC] text-[#C88A20]",
};
...
export function Toast({
  ...
  return (
    <div
      className={cn(
        "fixed bottom-6 left-1/2 z-50 -translate-x-1/2 animate-slide-up rounded-2xl border px-5 py-3 shadow-card backdrop-blur-sm",
