...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen w-full overflow-x-hidden bg-ambient">
      ...
      <motion.div
        className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-sky-400 to-sky-300 p-12 lg:flex"
      ...
      >
        ...
        <div className="pointer-events-none absolute left-1/4 top-1/3 h-40 w-40 rounded-full bg-white/8" />
      ...
      <div className="flex w-full items-center justify-center px-6 lg:w-1/2">
        <FadeInUp className="w-full max-w-sm">
          ...
          >
            ...
            <h1 className="font-display text-2xl font-semibold text-neutral-900">{tRegister("title")}</h1>
            <p className="mt-1 text-sm text-neutral-500">{tRegister("subtitle")}</p>
          </motion.div>
          ...
          >
            ...
            <p className="mt-2 text-sm text-neutral-500">{tRegister("subtitle")}</p>
          </motion.div>
          ...
          >
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-neutral-600">{tRegister("name")}</label>
              <Input placeholder={tRegister("namePlaceholder")} value={name} onChange={(event) => setName(event.target.value)} required />
            </div>
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-neutral-600">{tRegister("email")}</label>
              <Input type="email" placeholder="you@example.com" value={email} onChange={(event) => setEmail(event.target.value)} required />
            </div>
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-neutral-600">{tRegister("password")}</label>
